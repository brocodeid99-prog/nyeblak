...
export default function MidtransModal({
  ...
  const rawClientKey = (((import.meta as any).env?.VITE_MIDTRANS_CLIENT_KEY as string) || 'Mid-client-emg2efCPxwQJor-f');
 ...
 const rawServerKey =
  ...
  const rawMerchantId = (((import.meta as any).env?.VITE_MIDTRANS_MERCHANT_ID as string) || 'M772816217');
